...
export default function Kost() {
  ...
  if (kost.length !== 0) {
    ...
    return (
      <main className="flex justify-center items-center min-h-[70vh] gap-2 md:p-2 lg:p-4 overflow-x-hidden lg:px-12">
        <h1 className="font-bold text-4xl">Tidak Ada Kost</h1>
      </main>
    );
  }
}
